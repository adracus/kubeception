...
func AddToManagerWithArgs(mgr manager.Manager, args AddArgs) error {
	...
	if err := ctrl.Watch(&source.Kind{Type: &v1alpha1.KeyPair{}}, &handler.EnqueueRequestForObject{}); err != nil {
		return err
	}

	if err := ctrl.Watch(&source.Kind{Type: &corev1.Secret{}}, &handler.EnqueueRequestForOwner{OwnerType: &v1alpha1.KeyPair{}, IsController: true}); err != nil {
		return err
	}
